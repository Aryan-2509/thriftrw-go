...
func (v *PersonalInfo) ToWire() (wire.Value, error) {
	...
	if v.Race != nil {
		w, err = wire.NewValueString(*(v.Race)), error(nil)
		if err != nil {
			return w, err
		}
		fields[i] = wire.Field{ID: 2, Value: w}
...
// GetRace returns the value of Race if it is set or its
// zero value if it is unset.
func (v *PersonalInfo) GetRace() (o string) {
	if v != nil && v.Race != nil {
		return *v.Race
	}
...
var ThriftModule = &thriftreflect.ThriftModule{
	...
	SHA1:     "29ff87a73c860add2d19995adbd0351cf24423c3",
